...
alg_name =  'LMS_GCobn'      # goal directed centering

alpha = 1e-5
alpha_mu = 0.01 # stepsize of centering
...
class GCobn():
    ...
    def step(self, x, z, w, b):
        ...
        self.mu = self.mu - self.alpha_mu * obn_coeff_for_mu * delta * w
...
if __name__ == "__main__":
    ...
    wb = np.zeros(d+1)
    input_normalizer = GCobn(alpha_mu=alpha_mu)
    MSE_list = []
    t = 0
