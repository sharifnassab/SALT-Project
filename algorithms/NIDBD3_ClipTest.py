...
beta_inc_clip = "maxmin_0.1" # "none"  or "max_float" or "min_float" or "maxmin_float"
beta_clip = "maxmin_10" # "none"  or "max_float" or "min_float" or "maxmin_float"
                    ...
                    for meta_stepsize in [1e-4,1e-3,1e-2]:
                            for beta_inc_clip in [ 
                                ...
                                for beta_clip in [ 
                                    ...
                                    if beta_inc_clip == "max_0.1" and beta_clip == "none":  # this is the standard NIDBD3 (alredy tested)
                                        continue
...
if __name__ == "__main__":
    ...
    for iteration in range(num_steps):
        ...
        if 1:
            ...
            beta[:-1] = beta[:-1] + np.clip(meta_stepsize * meta_beta_increment, a_min=beta_inc_clip_min, a_max=beta_inc_clip_max)
