...
alg_name =  'LMS_GCsignObn'      # goal directed centering

alpha = 1e-5
alpha_mu = 1e-1 # stepsize of centering
...
class GCsignObn():
    ...
    def step(self, x, z, w, b):
        ...
        self.mu = self.mu - self.alpha_mu * obn_coeff_for_mu * delta * np.sign(w)
...
if __name__ == "__main__":
    ...
    wb = np.zeros(d+1)
    input_normalizer = GCsignObn(alpha_mu=alpha_mu)
    MSE_list = []
    t = 0
