...
if __name__ == "__main__":
    ...
    for iteration in range(num_steps):
        ...
        try:
            ...
            v_c = RMSPc*v_c + (1-RMSPc)* ((wb[:-1])**2)
            normalizer_c = np.sqrt(v_c/(1-RMSPc**t)+1e-16) 
            ...
            h_c = h_decay_coeff_c * h_c - delta*wb[:-1]/normalizer_c
            
            c = c - alpha_c * delta * wb[:-1] / normalizer_c # This is the gradient update of the first layer weights
