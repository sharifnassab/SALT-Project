...
alg_name =  'LMS-2DN_'  # combinaiton of MDN and GMDN   (difference with 2DN is that the sign of MDN is corrected here)
alpha = 1e-4
eta0 = .001
theta_MDN = 1e-4
...
def main_loop(dataset=dataset, alpha=alpha, eta0=eta0, theta_MDN=theta_MDN, bias=bias):
    ...
    input_normalizer = _2DN_(theta=theta_MDN, eta0=eta0, weight_of_MDN=weight_of_MDN, transform=transform)
    MSE_list = []
