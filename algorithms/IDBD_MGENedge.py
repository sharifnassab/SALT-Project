...
alg_name =  'IDBD_MGENedge'   # hd stands for h decay
base_alg = 'LMS_MDN'
...
os_decay = 1.0
edge_param = .5   # how close to the edge
...
if __name__ == "__main__":
    ...
    for iteration in range(num_steps):
        ...
        try:
            ...
            overshoot_protection = edge_param/(update_size+1e-10)
            #if update_size>1:
            #    beta = beta +np.log(os_decay)

            h = h * h_decay_coeff + overshoot_protection*delta*xb
