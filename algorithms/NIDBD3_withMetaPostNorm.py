...
alg_name =  'NIDBD3_withMetaPostNorm' 
base_alg = 'LMS_MDN'
...
meta_post_norm = 0.001 # "none"  or float
...
if __name__ == "__main__":
    ...
    for iteration in range(num_steps):
        ...
        if 1:
            ...
            meta_beta_increment = delta_tilde*xb*h * np.sqrt(2*alpha[:-1]-alpha[:-1]**2)
            ...
            alpha = softmax( np.clip(beta, a_min=None, a_max=25) )
