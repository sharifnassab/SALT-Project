...
alg_name =  'LMS-MDN2'  # division by sigma in  beta_mu  update rather than h_update  (=> more alligned with theory)
alpha = 1e-4
eta0 = .001
theta_MDN = 1e-3
...
def run_once(dataset=dataset, alpha=alpha, eta0=eta0, theta_MDN=theta_MDN, bias=bias):
    ...
    input_normalizer = MDN2(theta=theta_MDN, eta0=eta0)
    MSE_list = []
